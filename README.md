...
Carpeta nombrada "proyecto 1" es el incio, un PPL clasico desarrollado en GAMS y Visual Studio Code, resubido al repositorio de GitHub, el archivo esta en la nube y sincronizado con VSC, ante culquier ajuste en VSC, se subira al instante en el repositorio. 
